      ...
      <div class="main_box">
        <div class="data_box_title"> 
          ...
          <div class="page_controls">
          	...
          	<div class="page_control"><a style="float: left;margin-left: 22px;width: 104px;" class="addnewdata" href="<?php echo base_url();?>listing_managment/listing/inquiry_type">‫الاستفسار عن قرض‬‎</a></div>
          </div>
        </div>
        ...
        <div class="data">
          ...
          <?php $list_child_types	=	$this->listing->get_list_child_count($list->list_child_id);?>
                <div class="main_tab" id="bingo<?php echo $list->list_child_id;?>">
                  <div class="gray_main_right_icon"></div>
                  <div class="tab_txt" style="width:auto !important margin-right:50px;"><?php echo $list->list_child_name;?>
                   <?php //if($list_child_types > 0):?>
                        <div class="tab_cotrols"> 
                          <a href="<?php echo base_url();?>listing_managment/sub_child_listing/<?PHP echo $list->list_child_id; ?>">
                              عرض الكل (<?php echo $list_child_types;?>)
                            </a> 
                      	</div>
                    <?php //endif;?>
                      <div class="page_control" style="float:left;"><a id="addnew" href="javascript:void(0)" onclick="viewNew('<?php echo $list->list_child_id;?>')">إضافة</a></div>
...
<!--                  <div class="tab_txt" style="width:auto !important margin-right:50px;">
                  ...
                  <div class="tab_cotrols">
                    ...
                    <a class="delete-btn" id="<?php echo $list->list_child_id;?>" data-url="<?php echo base_url();?>listing_managment/delete_child/<?php echo $list->list_child_id;?>" href="#_">
