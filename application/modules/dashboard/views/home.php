...
<div class="body_contant">
  ...
  <div id="fl_menu">
    ...
    <div class="label">+ خدمات أخري </div>

    <div class="menu"> <a href="#" class="menu_item"><img src="images/body/left_tab/calender.png" border="0" width="40" height="35" alt="النتيجة" /></a> <a href="#" class="menu_item" ><img src="images/body/left_tab/statstic.png" width="44" border="0" height="42" alt="الإحصائيات" /></a> <a href="#" class="menu_item"><img src="images/body/left_tab/note.png" width="44" border="0" height="39"  alt="المفكرة"/></a> <a href="#" class="menu_item"><img src="images/body/left_tab/contact.png" width="39" border="0" height="42" alt="إتصل بنـا"/></a> </div>
  ...
  <div class="main_contant">
    ...
    <tbody>
        <tr>
            <td>جميع المعاملات‎</td>
            <td><?php echo $jamee_ul_mamlaat;?></td>
        </tr>
        <?php foreach($count_sum as $total):?>
            <tr>
                <td>(<?php echo $total['lcount'];?>)‎ <?php echo $total['loan_category_name'];?> </td>
                <td><?php echo $total['lamount'];?></td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
<br /><br />
	...
	<table style="text-align:center;" class="table" id="tableSortable3" aria-describedby="tableSortable_info">
                                    <thead>
                                      ...
                                      <tr role="row">
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="tableSortable" rowspan="1" colspan="2" aria-label="Platform(s): activate to sort column ascending" style="text-align:center;">
                                        
                        <div class="table-responsive">
                                                             
							<div class="col-md-4"><a href="#">معاملات هذا اليوم</a><br /><?php echo $day_month_year->count_year;?></div>
							<div class="col-md-4"><a href="#"></i>معاملات هذا الشهر</a><br />
							  <?php echo $day_month_year->count_month;?></div>
							<div class="col-md-4"><a href="#"></i>معاملات هذا العام</a><br />
							  <?php echo $day_month_year->count_day;?></div>							
                        </div>
						<br><br>
							<div class="table-responsive">                            
							<div class="col-md-4"><a href="#">ذكور</a><br /><?php echo $ziker->ck;?> </div>
							<div class="col-md-4"><a href="#"></i>إناث</a><br /><?php echo $unsaa->ck;?> </div>
							<div class="col-md-4"><a href="#"></i>مشترك</a><br />
							  <?php echo $mushtarik->ck;?> </div>							
                        </div>
						<br><br>
                                    ...
                                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                                      <tr class="gradeA odd" bgcolor="#f5f5f5">
                                        <td colspan="2" width="303" class=" sorting_1">
                                         </td>
                                      </tr>
                                      <tr class="gradeA even">
                               
                                        <td class=" sorting_1"><p>الزيارات الأولية <span class="text-success"><?php echo $zayarat->ck;?></span></p>
                                          <h4><?php echo $zayarat->lamo;?> R.O</h4></td>
                                      </tr>
                                      <tr class="gradeA even">
                                        <td class=" sorting_1"><p>المعاملات الغير مكتملة </p>
                                          <h4><span class="label label-success"><?php echo $mamlaat_gair;?></span></h4></td>
                                        <td class=" sorting_1"><p>قرار اللجنة</p>
                                          <h4><span class="label label-success">412 قرار</span></h4></td>
                                      </tr>
                                      <tr class="gradeA even">
                                        
                                        <td class=" sorting_1"><p>زيارات صرف الدفعات <span class="text-success"><?php echo $zayarat_awaliya->ck;?></span></p>
                                          <h4><?php echo $zayarat_awaliya->lamo;?> R.O</h4></td>
                                      </tr>
									  <tr>
									  <td>المراجعين
									  </td>
									  <td>
									  						<br><br>
							<div class="table-responsive">                            
							<div class="col-md-4"><a href="#">ذكور</a><br /><?php echo $m_f_count->zakar;?> </div>
							<div class="col-md-4"><a href="#"></i>إناث</a><br /><?php echo $m_f_count->unsa;?> </div>
							<div class="col-md-4"><a href="#"></i>مشترك</a><br />
							  <?php echo $ferd_mushtariq->mushtariq;?> </div>							
                        </div><br>
									  </td>
									  </tr>
									  <tr>
										<td>إجمالي المبالغ المتبقية‎</td>
										<td><?php echo (isset($al_mubaligh->lamo) ? $al_mubaligh->lamo : '0');?></td>
									  </tr>
									  
									   <tr>
										<td>إجمالي الموافقات الأولي‎</td>
										<td><?php echo $al_muafqaat->lamo;?></td>
									  </tr>
                                    ...
                                    <?php $counter	=	'1';?>
                                    <?php foreach($al_muzafeen as $muzafeen):?>
                                    <tr>
                                        <td><?php echo $counter;?></td>
                                        <td><?php echo $muzafeen->firstname.' '.$muzafeen->lastname;?></td>
                                        <td><?php echo $muzafeen->total;?></td>
                                    </tr>
                                    <?php $counter++;?>
                                    <?php endforeach;?>
	...
	<!-- <div class="data_raw">
		<div class="data_box">
			<div ><a href="#">جميع المعاملات</a><br><?php echo $jamee_ul_mamlaat;?></div>
		</div>
	 </div>
	 ...
	 <div class="data_raw">
		 <div class="data_box">
			<?php foreach($count_sum as $total):?>
				<div ><a href="#"><?php echo $total['loan_category_name'];?> (<?php echo $total['lcount'];?>)</a><br><?php echo $total['lamount'];?></div>
			<?php endforeach;?>
		</div>
	</div>
	-->
    ...
    <div class="data_raw">
      ...
      <div class="data_box">
        ...
        <div class="data_box_title">
          ...
          <div class="data_box_title_icon"><img src="images/body/contant/data_icon.png" width="19" height="19" /></div>

          <div class="data_title">إدخـال البيانات</div>

        </div>

        <div class="data_chart" id="muz_4">
          ...
          <!--<table id="testgraph" class="graphtable">
            ...
            <tr>
              ...
              <td class="values"><div class="chart_bar">

                  <label class="chart_bar_labol">Adminstrator&nbsp; &nbsp; &nbsp;<span style="background-color: #8aad39; width:34px; text-align:right; padding-right:5px;">94%</span></label>

                </div>

                <div class="chart_bar">

                  <label class="chart_bar_labol">وليد&nbsp; &nbsp; &nbsp;<span style="background-color: #942b2b; width:34px; text-align:right; padding-right:5px;">20%</span></label>

                </div>

                <div class="chart_bar">

                  <label class="chart_bar_labol"> شاهين&nbsp; &nbsp; &nbsp;<span style="background-color: #1c407b; width:34px; text-align:right; padding-right:5px;">15%</span></label>

                </div>

                <div class="chart_bar">

                  <label class="chart_bar_labol"> admin_1&nbsp; &nbsp; &nbsp;<span style="background-color: #b2b7b8; width:34px; text-align:right; padding-right:5px;">30%</span></label>

                </div>

                <div class="chart_bar">

                  <label class="chart_bar_labol"> nour elden&nbsp; &nbsp; &nbsp;<span style="background-color: #396; width:34px; text-align:right; padding-right:5px;">18%</span></label>
      ...
      <div class="summery_box">
        ...
        <div class="summery_box_title">

          <div class="summery_box_title_icon"><img src="images/body/contant/summery_icon.png" width="22" height="19" /></div>

          <div class="summery_title">ملخص</div>

        </div>

        <div class="summery_data"  id="shortcuts">

          <div class="summery_raw">

            <div class="summery_department_number">15</div>

            <div class="summery_txt"> ذكر</div>

          </div>

          <div class="summery_raw">

            <div class="summery_ques_number">565</div>

            <div class="summery_txt">أنثى</div>

          </div>

          <div class="summery_raw">

            <div class="summery_team_number">94</div>

            <div class="summery_txt">تسجيل</div>
    ...
    <div class="data_raw">
      ...
      <div id="muz_6"></div>
        ...
        <div class="data_box_title">
          ...
          <div class="data_box_title_icon"><img src="images/body/contant/update.png" width="19" height="15" /></div>

          <div class="data_title">أخـر التحديثات</div>
        ...
        <div class="main_data">
          ...
          <div class="tab"> <a href="#">
            ...
            <div class="main_tab">
              ...
              <div class="tab_txt">جدول المسابقات باللون الأخضر</div>

              <div class="green_tab_kind">جدول المسابقات</div>
        ...
        <div class="main_data">
          ...
          <div class="tab"> <a href="#">
            ...
            <div class="main_tab">
              ...
              <div class="bule_main_right_icon"></div>

              <div class="tab_txt">جدول الأسئلة باللون الأزرق</div>

              <div class="bule_tab_kind">إضافة سؤال</div>
        ...
        <div class="main_data">
          ...
          <div class="tab"> <a href="#">
            ...
            <div class="main_tab">
              ...
              <div class="black_main_right_icon"></div>

              <div class="tab_txt">جدول المتسابقين الفرق باللون الأسود</div>

              <div class="black_tab_kind">إضافة متسابقين</div>
    ...
    <div class="right_nav_raw">
      ...
      <div class="nav_icon"><img src="images/body/right.png" width="60" height="60" /></div>

      قد تمت العملية بالشكل الصحيح </div>

    <div class="wrong_nav_raw">

      <div class="nav_icon"><img src="images/body/wrong.png" width="60" height="60" /></div>

      لم تتم العملية يرجي  التأكد من الأخطاء </div>

    <div class="hold_nav_raw">

      <div class="nav_icon"><img src="images/body/hold.png" width="60" height="60" /></div>

      العملية التي قمت بها ذات أهمية قصوي هل تريد القيام بها ؟ </div>

    <div class="info_nav_raw">

      <div class="nav_icon"><img src="images/body/infp.png" width="60" height="60" /></div>

      يوجد معلومات خاصة بهذه العمليه برجاء <a href="#">الضغط هنـا </a></div>
...
/*                ['IE',       26.8],
	...
	$('#muz_4').highcharts({
        ...
        title: {
            ...
            text: 'الدخول الإحصائي حسب الجنس'
        ...
        xAxis: {
            ...
            categories: ['الأحـد', 'الإثنين', 'الثــلاثاء', 'الإربعــاء', 'الخميــس', 'الجمعــة', 'السبــت']
