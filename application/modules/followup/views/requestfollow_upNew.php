    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="1">
		  ...
		  <div class="form_raw">
				  ...
				  <tr><td colspan='4'>موقع المشروع</td><td><input placeholder="موقع المشروع"  type="text"  name="evaluate_project_card" id="evaluate_project_card" class="NumberInput req ratings"   style="height: 80px;" value="0" value="<?php ?>" /></td><td><textarea name="project_card_text"></textarea></td></tr>
