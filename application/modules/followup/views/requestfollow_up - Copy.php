    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="1">
		  ...
		  <div class="form_raw">
				  ...
				  <tr><td colspan='4'>واجهة مقر المشروع</td><td><input  type="text" placeholder="واجهة مقر المشروع"  name="evaluate_interface_headquarter" id="evaluate_interface_headquarter" class="NumberInput req ratings" style="height: 80px;" value="<?php if(isset($evaluate_data) && !empty($evaluate_data)) echo $evaluate_data['paint_signs_text'];  ?>"/></td><td><textarea name="interface_headquarter_text"></textarea></td></tr>
				  ...
				  <tr><td>المجموع</td><td><input  type="text" placeholder="المجموع" class="NumberInput req" name="totalrating" id="totalrating" style="width:100%;" value="<?php if(isset($evaluate_data) && !empty($evaluate_data)) echo $evaluate_data['totalrating'];  ?>" readonly/></td><td>المتوسط: (مجموع/30)</td><td></td><td>التقييم</td><td>فوق المتوسط</td></tr>
				  </table>
