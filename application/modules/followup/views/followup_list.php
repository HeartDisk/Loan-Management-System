          ...
          <div class="data">
            ...
            <table id="example" class="table table-striped table-bordered gridtable" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <?php
					$fTotal = getCountsById('financial_returns',$applicatnt->applicant_id);
					$a1= $fTotal->total;
					/*$fTotal = getCountsById('support_parties',$applicatnt->applicant_id);
					$a2= $fTotal->total;
					$fTotal = getCountsById('evaluate_project',$applicatnt->applicant_id);
					$a3= $fTotal->total;
					$fTotal = getCountsById('annoted_details',$applicatnt->applicant_id);
					$a4= $fTotal->total;
					$fTotal = getCountsById('monthly_financial',$applicatnt->applicant_id);
					$a5= $fTotal->total;
					$fTotal = getCountsById('about_proejct_details',$applicatnt->applicant_id);
					$a6= $fTotal->total;*/
					
				?>

                <tr id="bingo<?php echo $applicatnt->applicant_id;?>" onclick="viewfollwup(<?php echo $applicatnt->applicant_id;?>)">
                  ...
                  <td>
                      ...
                      <?PHP if(check_permission($module,'u')==1) { ?><a href="<?php echo base_url() ?>followup/requestfollowup/<?php echo $applicatnt->applicant_id;?>">
                      ...
                      <a href="<?php echo base_url() ?>followup/viewfollowuplist/<?php echo $applicatnt->applicant_id;?>">(<?php echo  ($a1); ?>)</a>
                   </td>
