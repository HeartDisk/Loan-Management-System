        ...
        <div class="data">
          ...
          <div class="main_data">
            ...
            <h3>بيانات القرض</h3>
                ...
                <div class="user_txt txt_f"> رقم القرض:</div>

                <div class="user_field uft"> <?php echo $loan_data->ILOM_SEQUENCE; ?> </div>
				
              </div>

              <div class="form_raw">

                <div class="user_txt txt_f"> تاريخ الاتفاقية:</div>

                <div class="user_field uft"> <?php  echo $loan_data->ILOM_VAL_TRS_DATE;?> </div>
				
              </div>
              <div class="form_raw">
			  <div class="user_txt txt_f"> قيمة القرض:</div>

                <div class="user_field uft"> <?php  echo $loan_data->ILOM_AMOUNT;?> ريال عماني </div>
			  
			  </div>
			  <div class="form_raw">

                <div class="user_txt txt_f"> المبالغ المصروفة:</div>
				  <div class="user_field uft"><?php echo $loan_data->ILOM_WITHDRAWN_AMOUNT; ?> ريال عماني  </div>
                  <div class="user_txt txt_f">المبلغ المتبقي للصرف:</div>
                  <div class="user_field uft"><?php echo $loan_data->REMAIN_DISB; ?> ريال عماني</div> 
              </div>
			  <div class="form_raw">
			  <div class="user_txt txt_f">تاريخ انتهاء الصرف:</div>
                  <div class="user_field uft"><?php echo $loan_data->ILOM_DRAWDOWN_LMT_DATE; ?></div> 
			  </div>
              <?php
			  	if(isset($bank_gurantee) && !empty($bank_gurantee)){ 
				//echo "<pre>";
				//print_r($bank_gurantee);
				$bank = $bank_gurantee['0'];
				//print_r($bank);
			  ?>
			  	<h3>الضمانة البنكية (LG)</h3>
			  <div class="form_raw">
				  
                <div class="user_txt txt_f"> اسم المورد:</div>
				 <div class="user_field uft"> <?php echo $bank->SUPPLIER_NAME; ?></div>
				 <div class="user_txt txt_f"> تاريخ بدء الضمانة:</div>
				 <div class="user_field uft"> <?php echo $bank->LG_DATE_FROM; ?></div>
				 	 <div class="user_txt txt_f">تاريخ انتهاء الضمانة:</div>
				 <div class="user_field uft"> <?php echo $bank->LG_DATE_TO; ?></div>
              </div>
             <?php
				}
				print_r($bank_dist);
				if(isset($bank_dist) && !empty($bank_dist)){
			 ?> 
			  <h3>صرف الدفعات</h3>
			  <div class="form_raw">
              	<?php
					foreach($bank_dist as $dis){
				?>

                <div class="user_txt txt_f"> تاريخ الصرف :</div>
				  <div class="user_field uft"><?php echo $dist[0]->DISB_DATE; ?>  </div>
                  <div class="user_txt txt_f"> المبلغ المصروف:</div>
                  <div class="user_field uft"><?php echo $dist[0]->DISB_DATE; ?> ريال عماني</div> 
              </div>
             <?php
					}
				}
			 ?> 
              ...
              <?php
			  	if($repayment_schduale !="" && !empty($repayment_schduale)){ 
			  	//echo "<pre>";
				//print_r($repayment_schduale);
			  ?>
             <h3>جدول السداد</h3>
             
			  <div class="form_raw">
            	<div class="user_txt txt_f">أقساط فترة السماح:</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->ILOM_GRACE_PERD_PERIOD ?></div>
                  </div>
              <div class="form_raw">
            	<div class="user_txt txt_f">أشهر فترة السماح:</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->GRACE_MONTHS ?></div>
                  </div>
                  
              <div class="form_raw">
            	<div class="user_txt txt_f">أقساط السداد</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->ILOM_NB_INSTALL; ?></div>
            </div>
              <div class="form_raw">
            	<div class="user_txt txt_f">فترة السداد</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->PAYMENT_YEARS; ?></div>
            </div>
              <div class="form_raw">
            	<div class="user_txt txt_f">اجمالي المسدد</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->TOT_PAID; ?> ريال عماني</div>
            </div>
            <div class="form_raw">
            	<div class="user_txt txt_f">اجمالي المتبقي</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->TOT_OUTSTD; ?> ريال عماني</div>
            </div>
            <div class="form_raw">
            	<div class="user_txt txt_f">المبالغ المتأخرة</div>
                <div class="user_field uft"><?php echo $repayment_schduale[0]->TOT_PD; ?> ريال عماني</div>
            </div>
           ...
           <?php
				...
				//echo "<pre>";
				//print_r($banks_payment_exchange);
		 
		if(!empty($banks_payment_exchange)){
		?>
        	<div class="form_raw">
			<table width="650" border="1">
<tbody><tr style="background:#69F;"><td>التسلسل‬&lrm;</td><td>‫مبلغ القائم‬&lrm;‬&lrm;</td><td>تاريخ الاستحقاق&lrm;‬&lrm;‬&lrm;</td><td>‫‫مبلغ القسط‬&lrm;‬&lrm;‬&lrm;</td><td>‫الرسوم</td><td>المبلغ المسدد‬&lrm;</td><td>حالة القسط‬&lrm;</td></tr>
		<?php
			foreach($banks_payment_exchange as $payment ){
				?>
          <tr><td><?php echo $payment->ILOM_SEQUENCE; ?></td><td><?php echo $payment->ILOD_CPT_AMNT; ?></td><td><?php echo $payment->ILOD_BILL_MTR;?></td><td><?php echo $payment->ILOD_BILL_MNT;?></td><td><?php echo $payment->ILOD_BILL_INT;?></td><td><?php echo $payment->ILOD_PAID_MNT;?><td><?php echo $payment->ILOD_STATUS;?></td></tr>      
                <?php
			}
