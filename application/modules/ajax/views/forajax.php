	...
	$(document).ready(function () {
		...
		///////////////////////////////////		 
		 ...
		 $('.tempmain').blur(function(){
			...
			var cr_number = $.trim($('#cr_number').val());				 
			 if(value!='')
			 {	var applicant_info = $.ajax({
					  url: config.AJAX_URL+'saveTempInfo',
					  type: "POST",
					  data:{value:value,tempid:data_attribute[0],applicantid:data_attribute[1],type:'Main',column:column,reviews:reviews,idcard:idcard,phonenumber:phonenumber,cr_number:cr_number},
					  dataType: "html",
					  success: function(msg){}
					});
			 }			 
