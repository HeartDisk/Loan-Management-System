                ...
                <?php if(!empty($all_users)):?>
                    ...
                    <tr>
                        ...
                        <?PHP if(check_permission($module,'u')==1) { ?><a title="تعديل" class="needtip" href="<?php echo base_url() ?>inquiries/add_user_registeration/<?php echo $user->id;?>">
                            ...
                            <?PHP } ?>
                            <?PHP if(check_permission($module,'d')==1) { ?>	<a title="حذف" href="#" class="delete-btn needtip" id="<?php echo $user->id;?>" data-url="<?php echo base_url();?>inquiries/delete_user/<?php echo $user->id;?>">
