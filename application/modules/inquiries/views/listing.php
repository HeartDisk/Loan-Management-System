      ...
      <div class="main_box">
        <div class="data_box_title"> 
          ...
          <div class="page_controls">
            ...
            <div class="page_control"><a style="float: left;margin-left: 93px;width: 120px;" class="addnewdata" href="<?php echo base_url();?>inquiries/listing">‫الاستفسار عن قرض‬‎</a></div>
          </div>
          <!--<div class="page_controls">
        ...
        <div class="data">
          <div class="main_data">
            ...
            <div class="main_tab">
              ...
              <div class="tab_cotrols"> 
                  <a href="<?php echo base_url();?>inquiries/listing/<?php echo $listdata->list_type; ?>">
                     عرض الكل
                    </a> 
              </div>
            </div>
