      ...
      <div class="data_raw">
        <div class="main_box">
          <div class="data_box_title"> 
            <div class="data_title">قائمة معاملات ‫مشروطة</div>
          </div>
          <div class="data">
            ...
            <tfoot>
             ...
             <tbody>
              ...
              <tr id="bingo<?php echo $applicatnt->applicant_id;?>">
                ...
                <td>
                    <?PHP if(check_permission($module,'u')==1) { ?><a href="<?php echo base_url() ?>inquiries/requestchagephasefive/<?php echo $applicatnt->applicant_id.'/'.$applicatnt->form_step;?>">
