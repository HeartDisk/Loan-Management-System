    ...
    <div class="data_raw">
      <div class="main_box">
        <div class="data_box_title">
          ...
          <div class="data_title">تسجيل الموظف</div>
          ...
          <div class="main_data">
            <form action="<?php echo current_url();?>" method="POST" id="validate_form_new" name="validate_form_new">
              ...
              <div class="form_raw">
                ...
                <div class="form_field">
                  <input type="password" class="txt_field <?PHP if($single_user->id=='') { ?>req<?PHP } ?>" name="password" id="password" placeholder="كلمة السر" value="<?php echo (isset($single_user->id) ? '123456' : NULL);?>"/>
                </div>
              </div>
              <div class="form_raw">
                <div class="form_txt">تأكيد كلمة المرور</div>
                <div class="form_field">
                  <input type="password" class="txt_field  <?PHP if($single_user->id=='') { ?>req<?PHP } ?>" name="confirm_password" id="confirm_password" placeholder="تأكيد كلمة المرور" value="<?php echo (isset($single_user->id) ? '123456' : NULL);?>"/>
                </div>
              </div>
              <div class="form_raw">
          	...
          	<div class="form_raw">
                ...
                <div class="form_field_selected">
                	<?php get_branches('branch_id',$single_user->branch_id);?>
                </div>
              </div>
              <div class="form_raw">
                <div class="form_txt">‫القسم‬‎</div>
                <div class="form_field_selected">
                	<?php parent_dropbox('user_parent_role',$single_user->user_parent_role);?>
                </div>
              </div>
              
              <div class="form_raw">
                <div class="form_txt">‫الوظيفة‬‎</div>
                <div class="form_field_selected" id="get_parent_roles">
                	<?php /*?><select  name="user_role_id" id="user_role_id" placeholder="اختر الوظيفة" >
                    	<option value="">اختر الوظيفة</option>
                    </select><?php */?>
                    <?php child_dropbox_role('user_role_id',$single_user->user_role_id,'',$single_user->user_parent_role);?>
