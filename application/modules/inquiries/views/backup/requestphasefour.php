            ...
            <!--<div class="data_title" style="padding-right: 15px;">مخاطر الإئتمان </div>-->
              ...
              <div id="details" >  
					...
					if(!empty($financeData)){
                        ...
                        <div class="form_raw unmusanif"  id="type_value2">
                         <div class="user_txt">مبلغ القرض</div>
                          <div class="user_field">
                           <input name="loan_amount[]" id="loan_amount" value="<?PHP echo $loan_amount[$i]; ?>"  placeholder="مبلغ القرض" type="text" class="ssForm txt_field NumberInput">
                          </div>
                		</div>
                ...
                <div class="form_raw unmusanif"  id="type_value2" style="display:none;">
                  ...
                  <div class="user_field">
                   <textarea name="musanif_notes[]" id="notes" placeholder="الملاحظات"  class="ssForm txt_field" ><?PHP echo rQuote($project_difficulties[$i]); ?></textarea>
                  </div>
