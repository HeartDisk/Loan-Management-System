            ...
            <tfoot>
             ...
             <tbody>
              ...
              <tr id="bingo<?php echo $applicatnt->applicant_id;?>">
                ...
                <td>
                    <?PHP if(check_permission($module,'u')==1) { ?><a title="تعديل" class="needtip" id="<?php echo $applicatnt->applicant_id;?>" href="<?php echo base_url();?>inquiries/newrequest/<?php echo $applicatnt->applicant_id;?>/4"><img src="<?php  echo base_url();?>images/body/contant/edit.png" width="16" height="16" /></a><?PHP } ?>
