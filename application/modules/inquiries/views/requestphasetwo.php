      ...
      <div class="main_data">
        <div class="personal" id="personal2">
          ...
          <div class="form_raw">
            ...
            <div class="user_txt">الاسم التجاري للمشروع</div>
            <div class="user_field">
              <input name="commercial_name" id="commercial_name" value="<?PHP echo $main->commercial_name; ?>" data-handler="<?PHP echo $main->tempid; ?>_<?PHP echo $main->tempid; ?>" placeholder="الاسم التجاري للمشروع" type="text" class="txt_field req">
            </div>
