      ...
      <div class="data_raw">
        ...
        <div class="main_box">
          ...
          <div class="data_box_title"> 
            ...
            <div class="data_title">قائمةالموافقة </div>
              ...
              <tbody>
                ...
                <tr id="bingo<?php echo $applicatnt->applicant_id;?>" ondblclick="viewFrom(<?php echo $applicatnt->applicant_id;?>)">
                  ...
                  <td>
                      ...
                      <?PHP if(check_permission($module,'u')==1) { ?><a href="<?php echo base_url() ?>inquiries/requestmuwafiqawalia/<?php echo $applicatnt->applicant_id;?>">
                      ...
                      <a href="#" class="checklist" id="<?php echo $applicatnt->applicant_id;?>">

                      <img src="<?php  echo base_url();?>images/checkList.png" width="16" height="16"/>
