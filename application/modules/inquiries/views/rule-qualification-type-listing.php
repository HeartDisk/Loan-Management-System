...
function submit_form()
{
		var str	=	$("#save_data_form2").serialize();
		 ...
		 var request = $.ajax({
		  url: config.BASE_URL+'inquiries/add_rules_qualification',
		  type: "POST",
		  data: str,
		  dataType: "html",
		  success: function(msg){
      ...
      <div class="main_box">
        <div class="data_box_title"> 
          ...
          <div class="page_controls">
          	...
          	<div class="page_control"><a style="float: left;margin-left: 93px;width: 104px;" class="addnewdata" href="<?php echo base_url();?>inquiries/rule_qualification_listing">‫نوع القائمة‬‎</a></div>
          </div>
        ...
        <div class="data">
          ...
          <?php $list_child_types	=	$this->listing->get_list_child_count($list->list_id);?>
                ...
                <div class="main_tab" id="bingo<?php echo $list->list_id;?>">
                  ...
                  <?php
				  	if($list->list_type != 'inquiry_type' AND $list->list_type != 'rules' AND $list->list_type != 'business_type' AND $list->list_type != 'activity_project' AND $list->list_type != 'project_employment' AND $list->list_type != 'project_type'){
				  ?>
                  ...
                  <div id="show<?php echo $list->list_id;?>" style="display:none; color:#060;margin-top: -20px; margin-right: 36px;">&#10004;</div>
                      <?PHP if(check_permission($module,'d')==1) { ?><div id="hide<?php echo $list->list_id;?>" style="display:none; color:#060;margin-top: -20px; margin-right: 36px;"><img src="<?php echo base_url();?>images/body/contant/delete.png" width="16" height="16" /> </div><?PHP } ?>
                  </div>
                  <?php
					}
					else
