            ...
            <table id="example" class="table table-striped table-bordered gridtable" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr id="bingo<?php echo $applicatnt->applicant_id;?>">
                  ...
                  <td></td>
                  <td>
                  <!--<a href="<?php echo base_url() ?>inquiries/updatezyarat/<?php //echo $applicatnt->applicant_id;?>">
                      <img src="<?php  echo base_url();?>images/body/contant/edit.png" width="16" height="16" />
                      </a>-->
                        <?PHP if(check_permission($module,'d')==1) { ?>
                      <a href="#" class="delete-btn" id="<?php echo $applicatnt->applicant_id;?>" data-url="<?php echo base_url();?>inquiries/delete_applicant/<?php echo $applicatnt->applicant_id;?>">
                      ...
                      <img src="<?php  echo base_url();?>images/view.png" width="16" height="16"/>
                       ...
                       <a href="<?php echo base_url() ?>inquiries/viewzyaratlist/<?php echo $applicatnt->applicant_id;?>" id="<?php echo $applicatnt->applicant_id;?>">
                      (<?php echo $applicatnt->total; ?>)
                      </a>
                      <?PHP } ?>
                   </td>
                </tr>
