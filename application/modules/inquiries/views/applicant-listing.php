            ...
            <tfoot>
             ...
             <tbody>
              ...
              <tr id="bingo<?php echo $applicatnt->applicant_id;?>">
                ...
                <td>
					<a title="حذف" class="delete-btn needtip" id="<?php echo $applicatnt->applicant_id;?>" href="#"  data-url="<?php echo base_url();?>inquiries/delete_applicant/<?php echo $applicatnt->applicant_id;?>"><img src="<?php  echo base_url();?>images/body/contant/delete.png" width="16" height="16" /></a>
