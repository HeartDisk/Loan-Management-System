...
<div class="data">
   ...
   <form action="" method="POST" id="save_data_form2" name="save_data_form2">
                ...
                <div class="form_field">
                  <input type="text" class="txt_field req" name="list_name" id="list_name" placeholder="قائمة الاسم" />
                </div>
        ...
        <div class="data">
          ...
          <?php $list_child_types	=	$this->listing->get_list_child_count($list->list_id);?>
                ...
                <div class="main_tab" id="bingo<?php echo $list->list_id;?>">
                  ...
                  <?php
				  	if($list->list_type != 'inquiry_type' AND $list->list_type != 'rules' AND $list->list_type != 'qualification' AND $list->list_type != 'business_type' AND $list->list_type != 'activity_project' AND $list->list_type != 'project_employment' AND $list->list_type != 'project_type' AND $list->list_type == 'conversion' AND $list->list_type == 'postponed' AND $list->list_type == 'rejected'){
				  ?>
                  ...
                  <?php
                        ...
                        <div class="tab_cotrols"> 
                          <a href="<?php echo base_url();?>inquiries/types_child_listing/<?PHP echo $list->list_id; ?>">
                              عرض الكل (<?php echo $list_child_types;?>)
                            </a> 
                      	</div>
                        <?php endif;?>
						   <?php if($list->list_type == 'inquiry_type' || $list->list_type == 'conversion' || $list->list_type == 'postponed' || $list->list_type == 'rejected'):?>
                                <div class="page_control" style="float:left;"><a id="addnew" href="javascript:void(0)" onclick="add_child('<?php echo $list->list_id;?>')">إضافة</a></div>
                            <?php endif;?>
						<?php
					}
				  ?>
