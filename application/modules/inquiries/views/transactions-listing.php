           ...
           <thead>
            ...
            <tfoot>
             ...
             <tbody>
              ...
              <?php //echo '<pre>'; print_r($professional['applicant_partners']);
			  	if($applicatnt->is_reject =='1' && $applicatnt->loan_id ==''){
					$class = 'rejected';
				}
				else if($applicatnt->loan_id !=''){
					$class = 'accepted';
				}
				else{
					$class = '';
              ...
              <tr id="bingo<?php echo $applicatnt->applicant_id;?>">
                ...
                <td class="Number <?php echo $class; ?>"><?php echo applicant_number($applicatnt->applicant_id);?></td>
