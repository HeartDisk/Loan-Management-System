      ...
      <div class="main_box">
        <div class="data_box_title"> 
          ...
          <div class="page_controls">
          	<div class="page_control"><a style="float: left;margin-left: 93px;width: 104px;" class="addnewdata" href="<?php echo base_url();?>inquiries/listing/inquiry_type">‫الاستفسار عن قرض‬‎</a></div>
          </div>
                  ...
                  <div class="tab_txt" style="width:auto !important margin-right:50px;"><?php echo $list->list_name;?>
                   <?php //if($list_child_types > 0):?>
                        <div class="tab_cotrols"> 
                          <a href="<?php echo base_url();?>inquiries/types_sub_child_listing/<?PHP echo $list->list_id; ?>">
