    ...
    <div class="main_data">
      ...
      <div class="applicant">
        <div class="form_raw">
          ...
          <div class="user_field">
            <input name="applicant_first_name" value="<?PHP  if(isset($type) && $type != "inquiry") { echo $applicant->applicant_first_name; } else{ if(isset($type) && $type == "inquiry") { echo $applicant->first_name; } } ?>" placeholder="الاسم الأول" id="applicant_first_name" type="text" class="txt_field  req">
          </div>
          <div class="user_txt" style="margin-right: 11px;">الاسم الثاني</div>
          <div class="user_field">
            <input name="applicant_middle_name" value="<?PHP if(isset($type) && $type != "inquiry") { echo $applicant->applicant_middle_name; } else{ if(isset($type) && $type == "inquiry") { echo  $applicant->middle_name; } } ?>" placeholder="الاسم الثاني" id="applicant_middle_name" type="text" class="txt_field req">
          </div>
        </div>
        <div class="form_raw">
          <div class="user_txt">الاسم الثالث</div>
          <div class="user_field">
            <input name="applicant_last_name" value="<?PHP  if(isset($type) && $type != "inquiry") { echo $applicant->applicant_last_name; } else{ if(isset($type) && $type == "inquiry") { echo  $applicant->last_name; } } ?>" placeholder="الاسم الثالث" id="applicant_last_name" type="text" class="txt_field  req">
          </div>
          <div class="user_txt" style="margin-right: 11px;">القبيلة / العائلة</div>
          <div class="user_field">
            <input name="applicant_sur_name" value="<?PHP  if(isset($type) && $type != "inquiry") { echo $applicant->applicant_sur_name; } else{ if(isset($type) && $type == "inquiry") { echo  $applicant->family_name; } }  ?>" placeholder="القبيلة / العائلة" id="applicant_sur_name" type="text" class="txt_field  req">
          </div>
        </div>
        <div class="form_raw">
      ...
      <div class="personal" id="personal2">
        ...
        <div class="form_raw">
          ...
          <div class="user_field">
            <input name="applicant_date_birth" type="text"  value="<?PHP echo date('Y-m-d',strtotime($applicant->applicant_date_birth)); ?>" class="txt_field" id="applicant_date_birth" placeholder="تاريخ الميلاد" size="15" maxlength="10">
      ...
      <div class="form_raw">
        ...
        <div class="user_field">
          <?PHP hd_dropbox('applicant_job_staus',$applicant->applicant_job_staus,'اختر الوضع الحالي','current_situation','req',$applicant->applicant_job_status_text,'','applicant_job_status_text'); ?>
        </div>
      </div>
      ...
      <div class="form_raw">
        ...
        <div class="user_field">
          <input id="option1" class="option_single" type="radio" <?PHP if($applicant->option1=='Y') { ?>checked="checked"<?PHP } ?> name="option1" value="Y" />
          نعم
          <input id="option1" class="option_single" <?PHP if($applicant->option1=='N') { ?>checked="checked"<?PHP } ?> type="radio" name="option1" value="N" />
          لا </div>
        <div class="user_field" id="option_txt_id" style=" <?PHP if($applicant->option1=='N') { ?>display:none;<?PHP } ?> margin-right: 33px;">
      ...
      <div class="form_raw">
        ...
        <div class="user_field">
          <input id="option2" <?PHP if($applicant->option2=='Y') { ?>checked="checked"<?PHP } ?> type="radio" name="option2" value="Y" class="option_single" />
          نعم
          <input id="option2" <?PHP if($applicant->option2=='N') { ?>checked="checked"<?PHP } ?> type="radio" name="option2" value="N" class="option_single"/>
          لا </div>
        <div class="user_field" style="padding-right: 19px; <?PHP if($applicant->option2=='N') { ?>display:none;<?PHP } ?>" id="disable">
          <?PHP 
      ...
      <div class="form_raw">
        <div class="user_field">
          <table width="100%" border="0" cellspacing="0" cellpadding="1">
            ...
            <tr>
              <td><input type="text" value="<?PHP echo $applicant->department; ?>" class="txt_field" name="department" placeholder="الشقة"></td>
      ...
      <div class="form_raw">
				  ...
				  <div id="drag0" class="uploader">
					  ...
					  <label style="width: 150px;">
						...
						<input type="file" name="document_id_1" id="document_id_1" title='بطاقة سجل القوى العاملة' onclick="apply_name('document_id_1')">
                        <input type="hidden" name="document_name_1" id="document_name_1"  value="<?php echo $applicant->document_name_1;  ?>" >
					  </label>
					</div>
				  </div>
        ...
        <?php 
				if(isset($applicant->document_name_1) && $applicant->document_name_1 !=""){
			?>
               <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_1;  ?>">تحميل</a>
                  </div>         
             <?php
				}
			 ?> 
      ...
      <div class="form_raw">
      						  <div id="drag1" class="uploader">
						<div class="browser">
					  <label style="width: 150px;">
						<span>البطاقة الشخصية</span>
						<input type="file" name="document_id_2" id="document_id_2"  title='البطاقة الشخصية' onclick="apply_name('document_id_2')">
					  <input type="hidden" name="document_name_2" id="document_name_2" value="<?php echo $applicant->document_name_2;  ?>"  >
                      </label>
					</div>
				  </div>
			...
			<?php 
				if(isset($applicant->document_name_2) && $applicant->document_name_2 !=""){
			?>
               <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_2;  ?>">تحميل</a>
                  </div>         
             <?php
				}
			 ?>     
		...
		<div class="form_raw">
      						  <div id="drag2" class="uploader">
						<div class="browser">
					  <label style="width: 150px;">
						<span>شهادة عدم محكومية</span>
						<input type="file" name="document_id_3" id="document_id_3"  title='البطاقة الشخصية' onclick="apply_name('document_id_3')">
					  <input type="hidden" name="document_name_3" id="document_name_3" value="<?php echo $applicant->document_name_3;  ?>"  >
                      </label>
					</div>
				  </div>
				  
				  <!-- /D&D Zone -->
				<div class="panel-body demo-panel-files" id='demo-files2'>
					  <span class="demo-note"></span>
					</div>
              <?php
			  if(isset($applicant->document_name_3) && $applicant->document_name_3 !=""){
              ?> 
              
               <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_3;  ?>">تحميل</a>
                  </div> 
               <?php
			  }
			   ?>            
      ...
      <div class="form_raw">
      						  <div id="drag4" class="uploader">
						<div class="browser">
					  <label style="width: 150px;">
						<span>دراسة الجدوى الإقتصادية للمشروع</span>
						<input type="file" name="document_id_5" id="document_id_5"  title='دراسة الجدوى الإقتصادية للمشروع' onchange="apply_name('document_id_5')">
					  	<input type="hidden" name="document_name_5" id="document_name_5"  value="<?php echo $applicant->document_name_5;  ?>" >
                      </label>
					</div>
				  </div>
				  
				  <!-- /D&D Zone -->
				<div class="panel-body demo-panel-files" id='demo-files4'>
					  <span class="demo-note"></span>
					</div>    
              <?php
			  if(isset($applicant->document_name_5) && $applicant->document_name_5 !=""){
              ?>
              <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_5;  ?>">تحميل</a>
                  </div>
                <?php
			  }
				?>         
      ...
      <div class="form_raw">
      						  <div id="drag5" class="uploader">
						<div class="browser">
					  <label style="width: 150px;">
						<span>صورة شمسية</span>
						<input type="file" name="document_id_6" id="document_id_6"  title='صورة شمسية' onclick="apply_name('document_id_6')">
					  	<input type="hidden" name="document_name_6" id="document_name_6"  value="<?php echo $applicant->document_name_6;  ?>" >
                      </label>
					</div>
				  </div>
				  
				  <!-- /D&D Zone -->
				<div class="panel-body demo-panel-files" id='demo-files5'>
					  <span class="demo-note"></span>
					</div>   
                  <?php
			  if(isset($applicant->document_name_6) && $applicant->document_name_6 !=""){
              ?>
                  <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_6;  ?>">download</a>
                  </div>
                <?php
			  }
				?>   
      ...
      <div class="form_raw">
      						  <div id="drag6" class="uploader">
						<div class="browser">
					  <label style="width: 150px;">
						<span>شهادات الخبرة / التدريب</span>
						<input type="file" name="document_id_7" id="document_id_7"  title='شهادات الخبرة / التدريب' onclick="apply_name('document_id_7')">
					  	<input type="hidden" name="document_name_7" id="document_name_7"  value="<?php echo $applicant->document_name_7;  ?>" >
                      </label>
					</div>
				  </div>
				  <!-- /D&D Zone -->
				<div class="panel-body demo-panel-files" id='demo-files6'>
					  <span class="demo-note"></span>
					</div>
           <?php
			  if(isset($applicant->document_name_7) && $applicant->document_name_7 !=""){
              ?>
           <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_7;  ?>">تحميل</a>
                  </div>
              <?php
			  }
			  ?>                  
      ...
      <div class="form_raw">
					  ...
					  <label style="width: 150px;">
						...
						<input type="file" name="document_id_8" id="document_id_8"  title='بطاقة الضمان الاجتماعي' onclick="apply_name('document_id_8')">
					  <input type="hidden" name="document_name_8" id="document_name_8"  value="<?php echo $applicant->document_name_8;  ?>">
                      </label>
					</div>
				  </div>
				  
				  <!-- /D&D Zone -->
				<div class="panel-body demo-panel-files" id='demo-files7'>
					  <span class="demo-note"></span>
					</div> 
           <?php
			  if(isset($applicant->document_name_8) && $applicant->document_name_8 !=""){
              ?>
           
                <div>
                  <a href="<?php echo  base_url();  ?>inquiries/downloadFile/<?php echo $applicant->document_name_8;  ?>">تحميل</a>
                  </div> 
               <?php
			  }
			   ?>
