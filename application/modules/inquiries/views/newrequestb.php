                    ...
                    <table width="100%">
                      ...
                      <tr>
                        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="1">
							...
							?>
                            <tr>
                              <td><input name="activity_name[]" type="text"  value="<?PHP echo $act->activity_name; ?>" class="txt_field  " id="activity_name" placeholder="اسم الجهة"></td>
                              <td><input name="activity_registration_no[]" type="text"  value="<?PHP echo $act->activity_registration_no; ?>" class="txt_field" id="activity_registration_no" placeholder="نشاط الجهة"></td>
                              <td><input name="activity_nationalmanpower[]" type="text"  value="<?PHP echo $act->activity_nationalmanpower; ?>" class="txt_field" id="activity_nationalmanpower" placeholder="المهنة المزاولة بالجهة"></td>
                              <td><input name="activity_laborforce[]" type="text"  value="<?PHP echo $act->activity_laborforce; ?>" class="txt_field " id="activity_laborforce" placeholder="عدد سنوات الخبرة"></td>
                            </tr>
                            <?PHP } ?>
                            <tr>
                              <td colspan="4" height="5"></td>
